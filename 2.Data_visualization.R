...
### Convert extracted dataframes as formal class object to create new phyloseqs with phylogeentic trees for the following sections ####

rarefied.min.wide.exclude.1.3.new = otu_table(rarefied.min.int.wide.exclude.1.3, taxa_are_rows = FALSE)

rarefied.min.prop.wide.exclude.1.3.new = otu_table(rarefied.min.prop.wide.exclude.1.3, taxa_are_rows = FALSE)

Tax.new = tax_table(Tax)
...
## First list the respective genus( photosyn) and Order
...
saveRDS(rarefied.chloroflexi.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.chloroflexi.int.exclude.1.3.rds")
saveRDS(rarefied.cyanobacteria.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.cyanobacteria.int.exclude.1.3.rds")
saveRDS(rarefied.proteobacteria.otherphoto.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.proteobacteria.otherphoto.int.exclude.1.3.rds")
saveRDS(rarefied.photosynthetic.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.photosynthetic.int.exclude.1.3.rds")
saveRDS(rarefied.chemolithotrophs.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.chemolithotrophs.int.exclude.1.3.rds")
saveRDS(rarefied.only.heterotrophs.int.exclude.1.3, "/path_to_output_directory/TMFZ/03_tabletax/rarefied.only.heterotrophs.int.exclude.1.3.rds")
