...
### Every section labelled 1-12, was split and run in separate chunk on the High Performance Computer servers.
### Section 13-15, could be executed together without loading any workspace if all required objects were saved as .rds files.
